...
@NamedQueries({
    ...
    @NamedQuery(name = "Vereda.findMuncipioDepartamentoById", query = "SELECT m,d from Vereda v INNER JOIN v.municipioId m INNER JOIN m.departamentoId d WHERE v.verId = :verId"),
